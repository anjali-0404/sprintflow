...
const data = `import { Project, Task, Metric, PricingPlan, Testimonial, CaseStudy, BlogPost, User, AIModule, Integration, Notification } from '../types';
...
export const pricingPlans: PricingPlan[] = [
  { id: 'starter', name: 'Starter', description: 'Perfect for founders', priceMonthly: 0, priceAnnual: 0, features: ['Up to 3 projects', 'Basic analytics', '5 AI requests/month', '1 workspace member'] },
  { id: 'growth', name: 'Growth', description: 'For growing startups', priceMonthly: 49, priceAnnual: 490, isPopular: true, features: ['Unlimited projects', 'Full analytics suite', '500 AI requests/month', 'Up to 10 team members', 'All AI modules'] },
  { id: 'scale', name: 'Scale', description: 'For advanced teams', priceMonthly: 149, priceAnnual: 1490, features: ['Everything in Growth', 'Unlimited AI requests', 'Unlimited team members', 'Custom integrations', 'Dedicated success manager'] },
];

export const testimonials: Testimonial[] = [
  { id: '1', content: 'We replaced 4 tools with SprintFlow AI.', author: { name: 'Sara Kim', role: 'CEO', company: 'Veridian Health', avatarInitials: 'SK', color: '#dbeafe' } },
  { id: '2', content: 'The AI Strategy Generator is worth the subscription.', author: { name: 'Marcus Reid', role: 'Founder', company: 'Nomad Studio', avatarInitials: 'MR', color: '#d1fae5' } },
  { id: '3', content: 'SprintFlow made weekly investor updates a 5-minute task.', author: { name: 'Priya Lal', role: 'CTO', company: 'Crux Health', avatarInitials: 'PL', color: '#fce7f3' } },
  { id: '4', content: 'Absolutely phenomenal tool for startups.', author: { name: 'David Chen', role: 'Designer', company: 'DesignCo', avatarInitials: 'DC', color: '#e0e7ff' } },
...
export const aiModules: AIModule[] = [
  { id: 'strategy', name: 'AI Strategy Generator', description: 'Generate full business strategies', icon: 'Lightbulb', examplePrompt: 'We are a B2B SaaS...', exampleResponse: 'Top 3 growth levers...' },
  { id: 'roadmap', name: 'AI Roadmap Builder', description: 'Describe your goals', icon: 'Map', examplePrompt: 'Build a Q3 roadmap', exampleResponse: 'Month 1...' },
  { id: 'meetings', name: 'AI Meeting Notes', description: 'Automatic summaries', icon: 'Mic', examplePrompt: 'Summarize meeting', exampleResponse: 'Action items...' },
  { id: 'competitor', name: 'AI Competitor Analysis', description: 'Real-time intel', icon: 'Crosshair', examplePrompt: 'Analyze Acme Corp', exampleResponse: 'Strengths...' },
